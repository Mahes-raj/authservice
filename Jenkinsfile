pipeline {
    ...
    environment {
        REPO_URL = 'https://github.com/projectemern/auth-service.git'
    ...
    stages {
        ...
        stage('Run with Docker Compose') {
            steps {
                script {
                    echo 'Starting Auth Service and dependencies using docker-compose...'
    ...
    post {
        success {
            echo 'Auth Service deployed successfully via Jenkins!'
        }
        failure {
